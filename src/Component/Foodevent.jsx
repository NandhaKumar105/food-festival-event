...
import nonveg from '../assets/food.png'
...
function Foodevent()
{
    ...
    const[sweet,setsweet]=useState(
        [
            ...
            {
                img:"https://i.ytimg.com/vi/5kkLA5CTp_4/maxresdefault.jpg",
                name:"Hot Badham"
            },
  ...
  <div class="container-fluid d-flex justify-content-between align-items-center px-3">
    <a class="navbar-brand mb-0" href="#">
      <img src={food} alt="" width="140" height="60" class="d-inline-block align-text-top ms-5 "/>
    </a>
    <button type="button" class="btn btn-danger me-5 ">Register</button>
  </div> 
</nav>
  ...
  <div className="container-fluid d-flex justify-content-between align-items-center">
    <a className="navbar-brand mb-0" href="#">
      <img
        ...
        alt="Logo"
        className="img-fluid"
        style={{ maxHeight: '100px', width: '120px' }}
      />
    </a>
...
{/* pic */}
        ...
        <div className='food'>
        <h3 className='text-danger text-center fw-bold fs-1'>More than a Food Festival </h3>
        <h4 className='text-white text-center'>25-05-2025 | Timings: 1:00 P.M to 5:00 P.M | Santho Lawns </h4>
...
<div className='d-flex mt-5 flex-wrap gap-5 justify-content-center'>
  ...
  <div className="card ms-3" style={{ width: '15rem' }}>
      ...
      <div className="card-body">
        <h6 className="card-text text-center">
         For College Students 10% Discount
        </h6>
      </div>
      </div>
      ...
      <div className="card ms-3" style={{ width: '15rem' }}>
      <img src="https://lh3.googleusercontent.com/p/AF1QipOkkRtmS3_ex6QaqwD5HeJ5263ujgT3RjdfY-vf=s1360-w1360-h1020-rw" className="card-img-top" alt="..." />
      <div className="card-body">
        <h6 className="card-text text-center">
        Luxury Place
        </h6>
...
{/* <div className='contact mt-5'>
    ...
    <div className='d-flex two text-center justify-content-between ps-5 mt-5'>
    <h5 className='borders border-white w-25  pt-1 '> <IoMail className='mail'/> abcd@gmail.com</h5>
    <h5 className='borders border-white w-25   pt-1'> <FaPhoneAlt/> 9791275774</h5>
    <h5 className='borders border-white w-25 me-5 pt-1'> <IoLocation/> <a href='https://g.co/kgs/SdEjxsy' className='text-decoration-none text-dark'>Santho Lawns</a></h5>
    </div>
  ...
  <div className="container mt-4">
    <div className="row text-center g-4">
      ...
      <div className="col-12 col-md-4">
        <h5 className="p-2 border border-white"><IoMail className="me-2" />abcd@gmail.com</h5>
      </div>

      <div className="col-12 col-md-4">
        <h5 className="p-2 border border-white"><FaPhoneAlt className="me-2" />9791275774</h5>
      </div>
...
{/* <div class="mb-3 enquiry">
  <h3 className='text-center mt-5 ms-5'>Stay Connected With Us</h3>
  <label for="exampleFormControlInput1" class="form-label mt-5" style={{marginLeft:"34%"}}>Name:</label>
  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Enter Your Name" style={{width:"35rem",marginLeft:"34%"}}/>

  <label for="exampleFormControlInput1" class="form-label mt-4"   style={{marginLeft:"34%"}}>Email:</label>
  <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@gmail.com" style={{width:"35rem",marginLeft:"34%"}}/>

  <div class="mb-3 text-center mt-4">
  <label for="exampleFormControlTextarea1" class="form-label"  style={{marginRight:"27%"}}>Comments:</label>
  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" style={{width:"35rem",marginLeft:"34%"}}></textarea>

  <button type="button" class="btn btn-danger mt-4" style={{width:"100px",marginLeft:"4%"}}>Send</button>
</div>   
</div> */}

<div className="container-fluid my-5 enquiry">
  <h3 className="text-center mb-4">Stay Connected With Us</h3>
      ...
      <div className="accordion" id="faqAccordion">
        ...
        <div className="accordion-item">
          ...
          <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
            <div className="accordion-body">
              No, you should pay ₹1999 per head and for children free entry upto 5years
            </div>
          </div>
        </div>
      ...
      {showPopup && (
        ...
        >
          ...
          >
            ...
            <p className='mt-4 fw-bold'>Limited Tickets available! grab your tickets soon</p>
            <button type="button" className="btn btn-danger px-4 mt-4">Register</button>
...
{showPopup && (
        ...
        >
          <div className="card shadow p-4 text-center" style={{ maxWidth: '400px', width: '90%',height:"250px" }}>
           ...
           <p className='mt-5 fw-bold'>Limited Tickets available! grab your tickets soon</p>
            <button type="button" className="btn btn-danger px-4 mt-4 w-50 " style={{marginLeft:"80px"}}>Register</button>
  ...
  <div className='text-center mt-5 contact p-3'>
    <h6>@ All Rights Reserved by Shine Creaft Technologies</h6>
  </div>
